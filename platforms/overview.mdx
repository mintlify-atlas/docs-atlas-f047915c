...
description: "Every execution platform Apache Wayang supports — Maven module, entry-point class, plugin registration, and which platforms to combine for each workload."
---
