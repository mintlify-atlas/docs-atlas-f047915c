...
description: "Add PostgreSQL, SQLite3, Kafka, Giraph, and TensorFlow to Wayang — plugin registration, connection properties, and operator coverage for each platform."
---
