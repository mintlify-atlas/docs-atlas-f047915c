...
description: "Configure and use Apache Spark as a Wayang execution platform — plugins, Maven setup, Spark configuration keys, RDD vs Dataset channels, and a complete example."
---
...
- **Sources**: `TextFileSource`, `ObjectFileSource`, `CollectionSource`, `ParquetSource`, `KafkaTopicSource`, `TableSink`
