...
description: "Configure Apache Wayang with property files and the Configuration API — covering logging, plan explanation, Spark, Flink, and Python settings."
---
...
| `wayang.core.fallback.udf.cpu.confidence` | `0.2` | Confidence for UDF CPU estimate interval. |
...
| `wayang.core.fallback.udf.ram.confidence` | `0.2` | Confidence for UDF RAM estimate interval. |
...
| `wayang.core.fallback.operator.cpu.confidence` | `0.2` | Confidence for operator CPU estimate interval. |
| `wayang.core.fallback.operator.ram.lower` | `100` | Lower bound for operator RAM cost. |
| `wayang.core.fallback.operator.ram.upper` | `1000` | Upper bound for operator RAM cost. |
| `wayang.core.fallback.operator.ram.confidence` | `0.2` | Confidence for operator RAM estimate interval. |
