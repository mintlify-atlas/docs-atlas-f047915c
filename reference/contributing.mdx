...
description: "How to contribute to Apache Wayang: set up your dev environment, build from source, run tests, open a pull request, and engage with the community."
---
...
Wayang enforces code style through [Checkstyle](https://checkstyle.sourceforge.io/) using the [Google Java Style](https://google.github.io/styleguide/javaguide.html) ruleset (`google_checks.xml`). Violations fail the build.
